...
#ifndef AI_USC_NETWORK_H
#define AI_USC_NETWORK_H
#pragma once
...
/******************************************************************************/
#define AI_USC_NETWORK_MODEL_NAME          "usc_network"
#define AI_USC_NETWORK_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_USC_NETWORK_ACTIVATIONS_ALIGNMENT   (4)
#define AI_USC_NETWORK_INPUTS_IN_ACTIVATIONS   (4)
#define AI_USC_NETWORK_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_USC_NETWORK_IN_NUM        (1)

AI_DEPRECATED
#define AI_USC_NETWORK_IN \
  ai_usc_network_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_USC_NETWORK_IN_SIZE { \
  AI_USC_NETWORK_IN_1_SIZE, \
}
#define AI_USC_NETWORK_IN_SIZE_BYTES { \
  AI_USC_NETWORK_IN_1_SIZE_BYTES, \
}
#define AI_USC_NETWORK_IN_1_HEIGHT      (60)
#define AI_USC_NETWORK_IN_1_WIDTH       (32)
#define AI_USC_NETWORK_IN_1_CHANNEL     (1)
#define AI_USC_NETWORK_IN_1_SIZE        (60 * 32 * 1)
#define AI_USC_NETWORK_IN_1_SIZE_BYTES  (7680)

/******************************************************************************/
#define AI_USC_NETWORK_OUT_NUM       (1)

AI_DEPRECATED
#define AI_USC_NETWORK_OUT \
  ai_usc_network_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_USC_NETWORK_OUT_SIZE { \
  AI_USC_NETWORK_OUT_1_SIZE, \
}
#define AI_USC_NETWORK_OUT_SIZE_BYTES { \
  AI_USC_NETWORK_OUT_1_SIZE_BYTES, \
}
#define AI_USC_NETWORK_OUT_1_CHANNEL     (11)
#define AI_USC_NETWORK_OUT_1_SIZE        (11)
#define AI_USC_NETWORK_OUT_1_SIZE_BYTES  (44)

/******************************************************************************/
#define AI_USC_NETWORK_N_NODES (11)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup usc_network
 ...
 * @ref ai_usc_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_usc_network_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_usc_network_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_usc_network_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_USC_NETWORK_*
 * defines into file @ref usc_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_usc_network_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_USC_NETWORK_H */
